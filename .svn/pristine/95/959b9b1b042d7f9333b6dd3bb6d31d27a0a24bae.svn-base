namespace Language.Display
{
	partial class ObjectTree
	{
		...
		private void InitializeComponent()
		{
			...
			this.ObjectType_ImageList.Images.SetKeyName( 0, "Base_Workspace.bmp" );
			this.ObjectType_ImageList.Images.SetKeyName( 1, "Product.bmp" );
			this.ObjectType_ImageList.Images.SetKeyName( 2, "Collector.bmp" );
			this.ObjectType_ImageList.Images.SetKeyName( 3, "Message_ID.png" );
			this.ObjectType_ImageList.Images.SetKeyName( 4, "Message_Content.png" );
			// 
			// ObjectTree
			// 
			this.ImageIndex = 0;
